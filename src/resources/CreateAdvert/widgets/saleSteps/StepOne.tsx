...
import { ICreateAdStepOne, useCreateSaleAdvert } from '../../entitites/createAdvert/model';
import { MaskedInput } from 'antd-mask-input';
import { useShallow } from 'zustand/react/shallow';
import { useUser } from 'Auth/entities';

export function CreateSaleAdvertStepOne({ onFinish }: { onFinish: onFinishStep }) {
    const { instance } = useCreateSaleAdvert(useShallow((state) => ({ instance: state.instance })));
    ...
    return (
        ...
        >
            ...
            <Form.Item label='Описание' labelAlign='left' name='description' initialValue={instance.description}>
