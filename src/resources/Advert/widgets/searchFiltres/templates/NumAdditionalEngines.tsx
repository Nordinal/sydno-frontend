...
}> = ({ min_num_additional_engines, max_num_additional_engines, changeConfigProperty }) => {
    return (
        <>
            ...
            <Row>
                <Col span={12}>
                    <InputNumber
                        ...
                        max={8}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('min_num_additional_engines', value || undefined)
                        }
                ...
                <Col span={12}>
                    <InputNumber
                        ...
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('max_num_additional_engines', value || undefined)
                        }
