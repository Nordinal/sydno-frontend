...
}> = ({ min_overall_length, max_overall_length, changeConfigProperty }) => {
    return (
        <>
            <p>Длинна судна, м</p>
            <Row>
                <Col span={12}>
                    <InputNumber
                        ...
                        style={{ width: '98%' }}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('min_overall_length', value || undefined)
                        }
                ...
                <Col span={12}>
                    <InputNumber
                        ...
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('max_overall_length', value || undefined)
                        }
