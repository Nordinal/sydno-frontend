...
export const CargoTanks: React.FC<{
...
}> = ({ cargo_tanks, min_total_capacity_cargo_tanks, max_total_capacity_cargo_tanks, changeConfigProperty }) => {
    ...
    return (
        <Row gutter={[8, 16]}>
            <Col span={12}>
                <p>Грузовой танк</p>
                <Switch onChange={handleSwitchClick} checked={cargo_tanks || undefined} size='small' />
            </Col>
            {cargo_tanks ? (
                <Col span={12}>
                    ...
                    <InputNumber
                        ...
                        max={100000}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>(
