...
}> = ({ min_gross_tonnage, max_gross_tonnage, changeConfigProperty }) => {
    return (
        <div>
            ...
            <Row>
                <Col span={12}>
                    <InputNumber
                        ...
                        style={{ width: '98%' }}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('min_gross_tonnage', value || undefined)
                        }
                ...
                <Col span={12}>
                    <InputNumber
                        ...
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('max_gross_tonnage', value || undefined)
                        }
