...
}> = ({ min_overall_width, max_overall_width, changeConfigProperty }) => {
    return (
        <>
            <p>Ширина судна, м</p>
            <Row>
                <Col span={12}>
                    <InputNumber
                        ...
                        style={{ width: '98%' }}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('min_overall_width', value || undefined)
                        }
                ...
                <Col span={12}>
                    <InputNumber
                        ...
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('max_overall_width', value || undefined)
                        }
