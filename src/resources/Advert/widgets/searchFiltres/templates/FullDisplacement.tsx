...
}> = ({ min_full_displacement, max_full_displacement, changeConfigProperty }) => {
    return (
        <>
            ...
            <Row>
                <Col span={12}>
                    <InputNumber
                        ...
                        style={{ width: '98%' }}
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('min_full_displacement', value || undefined)
                        }
                ...
                <Col span={12}>
                    <InputNumber
                        ...
                        onChange={(value) =>
                            changeConfigProperty<number | undefined>('max_full_displacement', value || undefined)
                        }
