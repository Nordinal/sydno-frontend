        ...
        <div className={s['sydno-footer']}>
            <div className={s['sydno-footer__container']}>
                <div className='flex items-center justify-center'>
                    ...
                    <Typography.Title level={4} style={{marginBottom: 0}}>Sydno</Typography.Title >
                </div>
                <div className='flex items-center justify-center mt-2'>
                    <span>
                        <Typography.Text type='secondary'>support:</Typography.Text>
                        <Button style={{padding: '0 4px', height: 'auto'}} type='link' href='mailto:sydno@mail.ru'>sydno@mail.ru</Button>
                    </span>
