    ...
    return (
        <div className={s['sydno-header']}>
            <div className={s['sydno-header-body']}>
                <div className={s['sydno-header-body-content']}>
                    <div className={s['sydno-container'] + ' flex justify-between items-center h-full'} style={{margin: '0 auto'}}>
                        ...
                        <div className={'flex justify-between items-center'}>
                            <div className={s['sydno-header-body-content-desctopmenu-main'] + ' flex justify-between items-center'}>
                                {auth !== null 
                            ...
                            <div className={s['sydno-header-body-content-desctopmenu-burger']}>
                                <MenuBurger
                                    padding="6px"
                                    status={burgerStatus}
                                    onClick={onMenuBurgerChangeHandler}
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div
                    className={s['sydno-header-body-dropdown'] + ' ' + (burgerStatus && s['sydno-header-body-dropdown-active'])}
                >
                ...
                <div onClick={closeDropDown} className={(burgerStatus ? s['sydno-header-body-dropdown-outside'] : '')}></div>
            </div>
        </div>
    );
}