...
export const RegionSelector = ({placeholder, value, onChange, style, allowClear}: {placeholder?: string, value?: {value: string}, onChange?: Function, style?: CSSProperties, allowClear?: boolean}) => {
